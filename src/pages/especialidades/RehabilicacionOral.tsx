...
const rehabilitacionOral = () => {
    const { t } = useLanguage();  
  const specialtyData = {
     title: t('oralRehabilitation.title'),
  titleEn: t('oralRehabilitation.title'),
  description: t('oralRehabilitation.subtitle'),
  descriptionEn: t('oralRehabilitation.subtitle'),
  image: "https://images.unsplash.com/photo-1581594693702-fbdc51b2763b?w=1920&h=1080&fit=crop",
  features: [
    t('oralRehabilitation.treatment1'),
    t('oralRehabilitation.treatment2'),
    t('oralRehabilitation.treatment3'),
    t('oralRehabilitation.treatment4'),
    t('oralRehabilitation.treatment5'),
    t('oralRehabilitation.treatment6'),
    t('oralRehabilitation.treatment7'),
    t('oralRehabilitation.treatment8'),
  ],
    testimonials: [
      {
